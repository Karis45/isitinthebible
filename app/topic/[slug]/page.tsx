      ...
      >
        ...
        <div style={{ maxWidth: 760, margin: "0 auto", padding: "16px 24px 0" }}>
          <nav aria-label="Breadcrumb">
            ...
            >
              <li>
                <Link href="/" style={{ color: "#8A7D72", textDecoration: "none" }}>
                  Home
                </Link>
              </li>
              ...
              <li>
                <Link
                  href="/#browse-topics"
                  style={{ color: "#8A7D72", textDecoration: "none" }}
                >
                  Topics
                </Link>
              </li>
        ...
        <header
          style={{
            background: "linear-gradient(135deg, #1A3A6A 0%, #0F2347 100%)",
            ...
            <div style={{ maxWidth: 400 }}>
              ...
              >
                <div
                  style={{
                    height: "100%",
                    width: `${((result.explicitnessScore - 1) / 4) * 88 + 6}%`,
                    background: scoreColor(result.explicitnessScore),
                    borderRadius: 100,
                    transition: "width .6s",
                  }}
                />
                ...
                >
                  <div
                    style={{
                      ...
                      marginTop: 4,
                      flexShrink: 0,
                      background: i === 0 ? "#1A3A6A" : "white",
                      border: `2px solid ${i === 0 ? "#1A3A6A" : "#D8D0C4"}`,
                      boxShadow: i === 0 ? "0 0 0 3px rgba(26,58,106,.15)" : "none",
                    }}
                  />
